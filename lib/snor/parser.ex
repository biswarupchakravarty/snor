...
# Generated at 2020-11-03 15:46:29Z.
...
defmodule Snor.Parser do
  ...
  defp parse_binary__18(rest, acc, stack, context, line, offset) do
    parse_binary__19(rest, [], [acc | stack], context, line, offset)
  end
  ...
  defp parse_binary__52(rest, acc, [_, previous_acc | stack], context, line, offset) do
    parse_binary__20(rest, acc ++ previous_acc, stack, context, line, offset)
  end

  defp parse_binary__53(_, _, [{rest, context, line, offset} | _] = stack, _, _, _) do
    parse_binary__21(rest, [], stack, context, line, offset)
  end

  defp parse_binary__54(rest, acc, stack, context, line, offset) do
    parse_binary__55(rest, [], [acc | stack], context, line, offset)
  end

  defp parse_binary__55(<<"{{{", rest::binary>>, acc, stack, context, comb__line, comb__offset) do
    parse_binary__56(rest, [] ++ acc, stack, context, comb__line, comb__offset + 3)
  end

  defp parse_binary__55(rest, _acc, stack, context, line, offset) do
    [acc | stack] = stack
  ...
  defp parse_binary__59(rest, acc, [_, previous_acc | stack], context, line, offset) do
    parse_binary__58(rest, acc ++ previous_acc, stack, context, line, offset)
  end

  defp parse_binary__60(_, _, [{rest, context, line, offset} | _] = stack, _, _, _) do
    parse_binary__59(rest, [], stack, context, line, offset)
  end
  ...
  defp parse_binary__62(
       ...
       when x0 === 32 do
    parse_binary__63(rest, acc, stack, context, comb__line, comb__offset + 1)
  end
  ...
  defp parse_binary__64(rest, user_acc, [acc | stack], context, line, offset) do
    _ = user_acc
    parse_binary__66(rest, acc, stack, context, line, offset)
  end

  defp parse_binary__66(rest, acc, [_, previous_acc | stack], context, line, offset) do
    parse_binary__58(rest, acc ++ previous_acc, stack, context, line, offset)
  end

  defp parse_binary__58(rest, user_acc, [acc | stack], context, line, offset) do
    _ = user_acc
  ...
  defp parse_binary__68(
       ...
       when (x0 >= 97 and x0 <= 122) or (x0 >= 65 and x0 <= 90) or (x0 >= 48 and x0 <= 57) or
              x0 === 95 or x0 === 46 do
    parse_binary__69(rest, [<<x0::integer>>] ++ acc, stack, context, comb__line, comb__offset + 1)
  end
  ...
  defp parse_binary__69(
       ...
       when (x0 >= 97 and x0 <= 122) or (x0 >= 65 and x0 <= 90) or (x0 >= 48 and x0 <= 57) or
              x0 === 95 or x0 === 46 do
    parse_binary__71(rest, [x0] ++ acc, stack, context, comb__line, comb__offset + 1)
  end
  ...
  defp parse_binary__72(rest, acc, stack, context, line, offset) do
    parse_binary__73(rest, [], [acc | stack], context, line, offset)
  end
  ...
  defp parse_binary__75(rest, acc, [_, previous_acc | stack], context, line, offset) do
    parse_binary__74(rest, acc ++ previous_acc, stack, context, line, offset)
  end

  defp parse_binary__76(_, _, [{rest, context, line, offset} | _] = stack, _, _, _) do
    parse_binary__75(rest, [], stack, context, line, offset)
  end
  ...
  defp parse_binary__78(
       ...
       when x0 === 32 do
    parse_binary__79(rest, acc, stack, context, comb__line, comb__offset + 1)
  end

  defp parse_binary__78(rest, _acc, stack, context, line, offset) do
    [acc | stack] = stack
    parse_binary__76(rest, acc, stack, context, line, offset)
  end

  defp parse_binary__79(
         <<x0::integer, rest::binary>>,
         acc,
         stack,
         context,
  ...
  defp parse_binary__80(rest, user_acc, [acc | stack], context, line, offset) do
    _ = user_acc
    parse_binary__82(rest, acc, stack, context, line, offset)
  end

  defp parse_binary__82(rest, acc, [_, previous_acc | stack], context, line, offset) do
    parse_binary__74(rest, acc ++ previous_acc, stack, context, line, offset)
  end

  defp parse_binary__74(rest, user_acc, [acc | stack], context, line, offset) do
    _ = user_acc
    parse_binary__83(rest, [] ++ acc, stack, context, line, offset)
  end

  defp parse_binary__83(<<"}}}", rest::binary>>, acc, stack, context, comb__line, comb__offset) do
    parse_binary__84(rest, [] ++ acc, stack, context, comb__line, comb__offset + 3)
  end
  ...
  defp parse_binary__84(rest, user_acc, [acc | stack], context, line, offset) do
    _ = user_acc
  ...
  defp parse_binary__85(rest, acc, [_, previous_acc | stack], context, line, offset) do
    parse_binary__20(rest, acc ++ previous_acc, stack, context, line, offset)
  end

  defp parse_binary__86(_, _, [{rest, context, line, offset} | _] = stack, _, _, _) do
  ...
  defp parse_binary__88(<<"{{", rest::binary>>, acc, stack, context, comb__line, comb__offset) do
    parse_binary__89(rest, [] ++ acc, stack, context, comb__line, comb__offset + 2)
  end

  defp parse_binary__88(rest, _acc, stack, context, line, offset) do
    [acc | stack] = stack
    parse_binary__86(rest, acc, stack, context, line, offset)
  end
  ...
  defp parse_binary__92(rest, acc, [_, previous_acc | stack], context, line, offset) do
    parse_binary__91(rest, acc ++ previous_acc, stack, context, line, offset)
  end

  defp parse_binary__93(_, _, [{rest, context, line, offset} | _] = stack, _, _, _) do
    parse_binary__92(rest, [], stack, context, line, offset)
  end
  ...
  defp parse_binary__95(
       ...
       when x0 === 32 do
    parse_binary__96(rest, acc, stack, context, comb__line, comb__offset + 1)
  end
  ...
  defp parse_binary__96(
       ...
       when x0 === 32 do
    parse_binary__98(rest, acc, stack, context, comb__line, comb__offset + 1)
  end

  defp parse_binary__96(rest, acc, stack, context, line, offset) do
    parse_binary__97(rest, acc, stack, context, line, offset)
  end

  defp parse_binary__98(rest, acc, stack, context, line, offset) do
    parse_binary__96(rest, acc, stack, context, line, offset)
  end

  defp parse_binary__97(rest, user_acc, [acc | stack], context, line, offset) do
    _ = user_acc
    parse_binary__99(rest, acc, stack, context, line, offset)
  end

  defp parse_binary__99(rest, acc, [_, previous_acc | stack], context, line, offset) do
    parse_binary__91(rest, acc ++ previous_acc, stack, context, line, offset)
  end

  defp parse_binary__91(rest, user_acc, [acc | stack], context, line, offset) do
    _ = user_acc
  ...
  defp parse_binary__101(rest, _acc, stack, context, line, offset) do
    [_, acc | stack] = stack
    parse_binary__86(rest, acc, stack, context, line, offset)
  end
  ...
  defp parse_binary__102(
       ...
       when (x0 >= 97 and x0 <= 122) or (x0 >= 65 and x0 <= 90) or (x0 >= 48 and x0 <= 57) or
              x0 === 95 or x0 === 46 do
    parse_binary__104(rest, [x0] ++ acc, stack, context, comb__line, comb__offset + 1)
  end
  ...
  defp parse_binary__105(rest, acc, stack, context, line, offset) do
  ...
  defp parse_binary__108(rest, acc, [_, previous_acc | stack], context, line, offset) do
    parse_binary__107(rest, acc ++ previous_acc, stack, context, line, offset)
  end

  defp parse_binary__109(_, _, [{rest, context, line, offset} | _] = stack, _, _, _) do
    parse_binary__108(rest, [], stack, context, line, offset)
  end
  ...
  defp parse_binary__111(
       ...
       when x0 === 32 do
    parse_binary__112(rest, acc, stack, context, comb__line, comb__offset + 1)
  end

  defp parse_binary__111(rest, _acc, stack, context, line, offset) do
    [acc | stack] = stack
    parse_binary__109(rest, acc, stack, context, line, offset)
  end

  defp parse_binary__112(
         <<x0::integer, rest::binary>>,
         acc,
         stack,
         context,
       ...
       when x0 === 32 do
    parse_binary__114(rest, acc, stack, context, comb__line, comb__offset + 1)
  end
  ...
  defp parse_binary__116(<<"}}", rest::binary>>, acc, stack, context, comb__line, comb__offset) do
    parse_binary__117(rest, [] ++ acc, stack, context, comb__line, comb__offset + 2)
  end

  defp parse_binary__116(rest, _acc, stack, context, line, offset) do
    [acc | stack] = stack
    parse_binary__86(rest, acc, stack, context, line, offset)
  end
  ...
  defp parse_binary__118(rest, acc, [_, previous_acc | stack], context, line, offset) do
    parse_binary__20(rest, acc ++ previous_acc, stack, context, line, offset)
  end

  defp parse_binary__119(_, _, [{rest, context, line, offset} | _] = stack, _, _, _) do
    parse_binary__87(rest, [], stack, context, line, offset)
  end

  defp parse_binary__120(rest, acc, stack, context, line, offset) do
  ...
  defp parse_binary__121(<<"{{", rest::binary>>, acc, stack, context, comb__line, comb__offset) do
    parse_binary__122(rest, acc, stack, context, comb__line, comb__offset + 2)
  end
  ...
  defp parse_binary__125(rest, acc, [_, previous_acc | stack], context, line, offset) do
    parse_binary__124(rest, acc ++ previous_acc, stack, context, line, offset)
  end

  defp parse_binary__126(_, _, [{rest, context, line, offset} | _] = stack, _, _, _) do
    parse_binary__125(rest, [], stack, context, line, offset)
  end
  ...
  defp parse_binary__128(
       ...
       when x0 === 32 do
    parse_binary__129(rest, acc, stack, context, comb__line, comb__offset + 1)
  end
  ...
  defp parse_binary__129(
       ...
       when x0 === 32 do
    parse_binary__131(rest, acc, stack, context, comb__line, comb__offset + 1)
  end
  ...
  defp parse_binary__131(rest, acc, stack, context, line, offset) do
    parse_binary__129(rest, acc, stack, context, line, offset)
  end

  defp parse_binary__130(rest, user_acc, [acc | stack], context, line, offset) do
    _ = user_acc
    parse_binary__132(rest, acc, stack, context, line, offset)
  end
  ...
  defp parse_binary__124(rest, user_acc, [acc | stack], context, line, offset) do
    _ = user_acc
  ...
  defp parse_binary__133(<<".", rest::binary>>, acc, stack, context, comb__line, comb__offset) do
    parse_binary__134(rest, acc, stack, context, comb__line, comb__offset + 1)
  end
  ...
  defp parse_binary__145(<<"}}", rest::binary>>, acc, stack, context, comb__line, comb__offset) do
    parse_binary__146(rest, acc, stack, context, comb__line, comb__offset + 2)
  end
  ...
  defp parse_binary__146(rest, user_acc, [acc | stack], context, line, offset) do
    _ = user_acc
    parse_binary__147(rest, [:current_element] ++ acc, stack, context, line, offset)
  end

  defp parse_binary__147(rest, acc, [_, previous_acc | stack], context, line, offset) do
    parse_binary__20(rest, acc ++ previous_acc, stack, context, line, offset)
  end

  defp parse_binary__20(rest, user_acc, [acc | stack], context, line, offset) do
    _ = user_acc
  ...
  defp parse_binary__148(rest, acc, [_, previous_acc | stack], context, line, offset) do
    parse_binary__1(rest, acc ++ previous_acc, stack, context, line, offset)
  end

  defp parse_binary__149(_, _, [{rest, context, line, offset} | _] = stack, _, _, _) do
  ...
  defp parse_binary__153(
    ...
    parse_binary__154(rest, [x0] ++ acc, stack, context, comb__line, comb__offset + 3)
  end

  defp parse_binary__153(rest, _acc, stack, context, line, offset) do
    [_, _, acc | stack] = stack
  ...
  defp parse_binary__157(rest, acc, [_, previous_acc | stack], context, line, offset) do
    parse_binary__156(rest, acc ++ previous_acc, stack, context, line, offset)
  end

  defp parse_binary__158(_, _, [{rest, context, line, offset} | _] = stack, _, _, _) do
    parse_binary__157(rest, [], stack, context, line, offset)
  end
  ...
  defp parse_binary__160(
       ...
       when x0 === 32 do
    parse_binary__161(rest, acc, stack, context, comb__line, comb__offset + 1)
  end

  defp parse_binary__160(rest, _acc, stack, context, line, offset) do
    [acc | stack] = stack
  ...
  defp parse_binary__161(
       ...
       when x0 === 32 do
    parse_binary__163(rest, acc, stack, context, comb__line, comb__offset + 1)
  end

  defp parse_binary__161(rest, acc, stack, context, line, offset) do
    parse_binary__162(rest, acc, stack, context, line, offset)
  end
  ...
  defp parse_binary__156(rest, user_acc, [acc | stack], context, line, offset) do
    _ = user_acc
    parse_binary__165(rest, [] ++ acc, stack, context, line, offset)
  end

  defp parse_binary__165(rest, acc, stack, context, line, offset) do
    parse_binary__166(rest, [], [acc | stack], context, line, offset)
  end

  defp parse_binary__166(
         <<x0::integer, rest::binary>>,
         acc,
         stack,
         context,
  ...
  defp parse_binary__166(rest, _acc, stack, context, line, offset) do
    [_, _, _, acc | stack] = stack
    parse_binary__149(rest, acc, stack, context, line, offset)
  end

  defp parse_binary__167(
         <<x0::integer, rest::binary>>,
         acc,
         stack,
         context,
       ...
       when (x0 >= 97 and x0 <= 122) or (x0 >= 65 and x0 <= 90) or (x0 >= 48 and x0 <= 57) or
              x0 === 95 or x0 === 46 do
    parse_binary__169(rest, [x0] ++ acc, stack, context, comb__line, comb__offset + 1)
  end
  ...
  defp parse_binary__170(rest, acc, stack, context, line, offset) do
  ...
  defp parse_binary__173(rest, acc, [_, previous_acc | stack], context, line, offset) do
    parse_binary__172(rest, acc ++ previous_acc, stack, context, line, offset)
  end

  defp parse_binary__174(_, _, [{rest, context, line, offset} | _] = stack, _, _, _) do
    parse_binary__173(rest, [], stack, context, line, offset)
  end
  ...
  defp parse_binary__176(
       ...
       when x0 === 32 do
    parse_binary__177(rest, acc, stack, context, comb__line, comb__offset + 1)
  end

  defp parse_binary__176(rest, _acc, stack, context, line, offset) do
    [acc | stack] = stack
    parse_binary__174(rest, acc, stack, context, line, offset)
  end

  defp parse_binary__177(
         <<x0::integer, rest::binary>>,
         acc,
         stack,
         context,
       ...
       when x0 === 32 do
    parse_binary__179(rest, acc, stack, context, comb__line, comb__offset + 1)
  end
  ...
  defp parse_binary__178(rest, user_acc, [acc | stack], context, line, offset) do
    _ = user_acc
    parse_binary__180(rest, acc, stack, context, line, offset)
  end

  defp parse_binary__180(rest, acc, [_, previous_acc | stack], context, line, offset) do
    parse_binary__172(rest, acc ++ previous_acc, stack, context, line, offset)
  end
  ...
  defp parse_binary__181(<<"}}", rest::binary>>, acc, stack, context, comb__line, comb__offset) do
    parse_binary__182(rest, [] ++ acc, stack, context, comb__line, comb__offset + 2)
  end

  defp parse_binary__181(rest, _acc, stack, context, line, offset) do
    [_, _, acc | stack] = stack
    parse_binary__149(rest, acc, stack, context, line, offset)
  end

  defp parse_binary__182(rest, user_acc, [acc | stack], context, line, offset) do
    _ = user_acc
    parse_binary__183(rest, [:lists.reverse(user_acc)] ++ acc, stack, context, line, offset)
  end

  defp parse_binary__183(<<"{{/", _::binary>> = rest, acc, stack, context, line, offset) do
    [_, acc | stack] = stack
    parse_binary__149(rest, acc, stack, context, line, offset)
  end
  ...
  defp parse_binary__185(<<"{{/", rest::binary>>, acc, stack, context, comb__line, comb__offset) do
    parse_binary__186(rest, [] ++ acc, stack, context, comb__line, comb__offset + 3)
  end
  ...
  defp parse_binary__189(rest, acc, [_, previous_acc | stack], context, line, offset) do
    parse_binary__188(rest, acc ++ previous_acc, stack, context, line, offset)
  end

  defp parse_binary__190(_, _, [{rest, context, line, offset} | _] = stack, _, _, _) do
    parse_binary__189(rest, [], stack, context, line, offset)
  end
  ...
  defp parse_binary__192(rest, _acc, stack, context, line, offset) do
    [acc | stack] = stack
    parse_binary__190(rest, acc, stack, context, line, offset)
  end

  defp parse_binary__193(
         <<x0::integer, rest::binary>>,
         acc,
         stack,
         context,
       ...
       when x0 === 32 do
    parse_binary__195(rest, acc, stack, context, comb__line, comb__offset + 1)
  end

  defp parse_binary__193(rest, acc, stack, context, line, offset) do
  ...
  defp parse_binary__196(rest, acc, [_, previous_acc | stack], context, line, offset) do
    parse_binary__188(rest, acc ++ previous_acc, stack, context, line, offset)
  end

  defp parse_binary__188(rest, user_acc, [acc | stack], context, line, offset) do
    _ = user_acc
  ...
  defp parse_binary__198(rest, _acc, stack, context, line, offset) do
    [_, _, acc | stack] = stack
    parse_binary__149(rest, acc, stack, context, line, offset)
  end

  defp parse_binary__199(
         <<x0::integer, rest::binary>>,
         acc,
         stack,
         context,
       ...
       when (x0 >= 97 and x0 <= 122) or (x0 >= 65 and x0 <= 90) or (x0 >= 48 and x0 <= 57) or
              x0 === 95 or x0 === 46 do
    parse_binary__201(rest, [x0] ++ acc, stack, context, comb__line, comb__offset + 1)
  end
  ...
  defp parse_binary__205(rest, acc, [_, previous_acc | stack], context, line, offset) do
    parse_binary__204(rest, acc ++ previous_acc, stack, context, line, offset)
  end

  defp parse_binary__206(_, _, [{rest, context, line, offset} | _] = stack, _, _, _) do
    parse_binary__205(rest, [], stack, context, line, offset)
  end
  ...
  defp parse_binary__208(
       ...
       when x0 === 32 do
    parse_binary__209(rest, acc, stack, context, comb__line, comb__offset + 1)
  end

  defp parse_binary__208(rest, _acc, stack, context, line, offset) do
    [acc | stack] = stack
    parse_binary__206(rest, acc, stack, context, line, offset)
  end

  defp parse_binary__209(
         <<x0::integer, rest::binary>>,
         acc,
         stack,
         context,
       ...
       when x0 === 32 do
    parse_binary__211(rest, acc, stack, context, comb__line, comb__offset + 1)
  end
  ...
  defp parse_binary__210(rest, user_acc, [acc | stack], context, line, offset) do
    _ = user_acc
    parse_binary__212(rest, acc, stack, context, line, offset)
  end

  defp parse_binary__212(rest, acc, [_, previous_acc | stack], context, line, offset) do
    parse_binary__204(rest, acc ++ previous_acc, stack, context, line, offset)
  end

  defp parse_binary__204(rest, user_acc, [acc | stack], context, line, offset) do
    _ = user_acc
    parse_binary__213(rest, [] ++ acc, stack, context, line, offset)
  end

  defp parse_binary__213(<<"}}", rest::binary>>, acc, stack, context, comb__line, comb__offset) do
    parse_binary__214(rest, [] ++ acc, stack, context, comb__line, comb__offset + 2)
  end

  defp parse_binary__213(rest, _acc, stack, context, line, offset) do
    [_, acc | stack] = stack
    parse_binary__149(rest, acc, stack, context, line, offset)
  end

  defp parse_binary__214(rest, user_acc, [acc | stack], context, line, offset) do
    _ = user_acc
  ...
  defp parse_binary__216(rest, acc, [_, previous_acc | stack], context, line, offset) do
    parse_binary__1(rest, acc ++ previous_acc, stack, context, line, offset)
  end

  defp parse_binary__217(_, _, [{rest, context, line, offset} | _] = stack, _, _, _) do
    parse_binary__150(rest, [], stack, context, line, offset)
  end

  defp parse_binary__218(rest, acc, stack, context, line, offset) do
    parse_binary__219(rest, [], [acc | stack], context, line, offset)
  end
  ...
  defp parse_binary__220(<<"{{", rest::binary>>, acc, stack, context, comb__line, comb__offset) do
    parse_binary__221(rest, [] ++ acc, stack, context, comb__line, comb__offset + 2)
  end
  ...
  defp parse_binary__222(rest, _acc, stack, context, line, offset) do
    [_, _, acc | stack] = stack
    parse_binary__217(rest, acc, stack, context, line, offset)
  end

  defp parse_binary__223(
         <<x0::integer, rest::binary>>,
         acc,
         stack,
         context,
       ...
       when (x0 >= 97 and x0 <= 122) or (x0 >= 65 and x0 <= 90) or (x0 >= 48 and x0 <= 57) or
              x0 === 95 or x0 === 46 do
    parse_binary__225(rest, [x0] ++ acc, stack, context, comb__line, comb__offset + 1)
  end
  ...
  defp parse_binary__225(rest, acc, stack, context, line, offset) do
    parse_binary__223(rest, acc, stack, context, line, offset)
  end

  defp parse_binary__224(rest, user_acc, [acc | stack], context, line, offset) do
    _ = user_acc
  ...
  defp parse_binary__226(<<" ", rest::binary>>, acc, stack, context, comb__line, comb__offset) do
    parse_binary__227(rest, [] ++ acc, stack, context, comb__line, comb__offset + 1)
  end
  ...
  defp parse_binary__228(rest, acc, stack, context, line, offset) do
    parse_binary__229(rest, [], [acc | stack], context, line, offset)
  end

  defp parse_binary__229(<<"='", _::binary>> = rest, acc, stack, context, line, offset) do
    [_, _, _, acc | stack] = stack
    parse_binary__217(rest, acc, stack, context, line, offset)
  end
  ...
  defp parse_binary__231(rest, _acc, stack, context, line, offset) do
    [_, _, _, _, acc | stack] = stack
    parse_binary__217(rest, acc, stack, context, line, offset)
  end

  defp parse_binary__232(
         <<x0::integer, rest::binary>>,
         acc,
         stack,
         context,
       ...
       when (x0 >= 97 and x0 <= 122) or (x0 >= 65 and x0 <= 90) or (x0 >= 48 and x0 <= 57) or
              x0 === 95 or x0 === 46 do
    parse_binary__234(rest, [x0] ++ acc, stack, context, comb__line, comb__offset + 1)
  end
  ...
  defp parse_binary__234(rest, acc, stack, context, line, offset) do
    parse_binary__232(rest, acc, stack, context, line, offset)
  end

  defp parse_binary__233(rest, user_acc, [acc | stack], context, line, offset) do
    _ = user_acc
  ...
  defp parse_binary__235(<<"='", rest::binary>>, acc, stack, context, comb__line, comb__offset) do
    parse_binary__236(rest, [] ++ acc, stack, context, comb__line, comb__offset + 2)
  end

  defp parse_binary__235(rest, _acc, stack, context, line, offset) do
    [_, _, _, acc | stack] = stack
    parse_binary__217(rest, acc, stack, context, line, offset)
  end
  ...
  defp parse_binary__237(rest, _acc, stack, context, line, offset) do
    [_, _, _, _, acc | stack] = stack
    parse_binary__217(rest, acc, stack, context, line, offset)
  end

  defp parse_binary__238(
         <<x0::integer, rest::binary>>,
         acc,
         stack,
         context,
  ...
  defp parse_binary__239(rest, user_acc, [acc | stack], context, line, offset) do
    _ = user_acc
  ...
  defp parse_binary__242(<<"'", rest::binary>>, acc, stack, context, comb__line, comb__offset) do
    parse_binary__243(rest, [] ++ acc, stack, context, comb__line, comb__offset + 1)
  end

  defp parse_binary__242(rest, _acc, stack, context, line, offset) do
    [_, _, acc | stack] = stack
    parse_binary__217(rest, acc, stack, context, line, offset)
  end
  ...
  defp parse_binary__244(<<" ", rest::binary>>, acc, stack, context, comb__line, comb__offset) do
    parse_binary__245(rest, acc, stack, context, comb__line, comb__offset + 1)
  end

  defp parse_binary__244(<<rest::binary>>, acc, stack, context, comb__line, comb__offset) do
    parse_binary__245(rest, acc, stack, context, comb__line, comb__offset)
  end
  ...
  defp parse_binary__246(rest, user_acc, [acc | stack], context, line, offset) do
    _ = user_acc
  ...
  defp parse_binary__247(rest, acc, stack, context, line, offset) do
    parse_binary__249(
      rest,
      [],
  ...
  defp parse_binary__251(<<"='", _::binary>> = rest, acc, stack, context, line, offset) do
    [_, acc | stack] = stack
    parse_binary__248(rest, acc, stack, context, line, offset)
  end
  ...
  defp parse_binary__252(rest, acc, stack, context, line, offset) do
    parse_binary__253(rest, [], [acc | stack], context, line, offset)
  end

  defp parse_binary__253(
         <<x0::integer, rest::binary>>,
         acc,
         stack,
         context,
  ...
  defp parse_binary__253(rest, _acc, stack, context, line, offset) do
    [_, _, acc | stack] = stack
    parse_binary__248(rest, acc, stack, context, line, offset)
  end

  defp parse_binary__254(
         <<x0::integer, rest::binary>>,
         acc,
         stack,
         context,
       ...
       when (x0 >= 97 and x0 <= 122) or (x0 >= 65 and x0 <= 90) or (x0 >= 48 and x0 <= 57) or
              x0 === 95 or x0 === 46 do
    parse_binary__256(rest, [x0] ++ acc, stack, context, comb__line, comb__offset + 1)
  end

  defp parse_binary__254(rest, acc, stack, context, line, offset) do
    parse_binary__255(rest, acc, stack, context, line, offset)
  end

  defp parse_binary__256(rest, acc, stack, context, line, offset) do
    parse_binary__254(rest, acc, stack, context, line, offset)
  end

  defp parse_binary__255(rest, user_acc, [acc | stack], context, line, offset) do
    _ = user_acc
  ...
  defp parse_binary__257(<<"='", rest::binary>>, acc, stack, context, comb__line, comb__offset) do
    parse_binary__258(rest, [] ++ acc, stack, context, comb__line, comb__offset + 2)
  end

  defp parse_binary__257(rest, _acc, stack, context, line, offset) do
    [_, acc | stack] = stack
    parse_binary__248(rest, acc, stack, context, line, offset)
  end
  ...
  defp parse_binary__259(rest, _acc, stack, context, line, offset) do
    [_, _, acc | stack] = stack
    parse_binary__248(rest, acc, stack, context, line, offset)
  end

  defp parse_binary__260(
         <<x0::integer, rest::binary>>,
         acc,
         stack,
         context,
  ...
  defp parse_binary__261(rest, user_acc, [acc | stack], context, line, offset) do
    _ = user_acc
  ...
  defp parse_binary__264(<<"'", rest::binary>>, acc, stack, context, comb__line, comb__offset) do
    parse_binary__265(rest, [] ++ acc, stack, context, comb__line, comb__offset + 1)
  end

  defp parse_binary__264(rest, _acc, stack, context, line, offset) do
    [acc | stack] = stack
    parse_binary__248(rest, acc, stack, context, line, offset)
  end

  defp parse_binary__265(rest, acc, stack, context, line, offset) do
  ...
  defp parse_binary__266(<<" ", rest::binary>>, acc, stack, context, comb__line, comb__offset) do
    parse_binary__267(rest, acc, stack, context, comb__line, comb__offset + 1)
  end

  defp parse_binary__266(<<rest::binary>>, acc, stack, context, comb__line, comb__offset) do
    parse_binary__267(rest, acc, stack, context, comb__line, comb__offset)
  end
  ...
  defp parse_binary__248(_, _, [{rest, acc, context, line, offset} | stack], _, _, _) do
    parse_binary__270(rest, acc, stack, context, line, offset)
  end

  defp parse_binary__269(
         inner_rest,
         inner_acc,
         [{rest, acc, context, line, offset} | stack],
         inner_context,
  ...
  defp parse_binary__270(<<"}}", rest::binary>>, acc, stack, context, comb__line, comb__offset) do
    parse_binary__271(rest, [] ++ acc, stack, context, comb__line, comb__offset + 2)
  end

  defp parse_binary__270(rest, _acc, stack, context, line, offset) do
    [_, acc | stack] = stack
    parse_binary__217(rest, acc, stack, context, line, offset)
  end
  ...
  defp parse_binary__272(rest, user_acc, [acc | stack], context, line, offset) do
    _ = user_acc
  ...
  defp parse_binary__273(rest, acc, [_, previous_acc | stack], context, line, offset) do
    parse_binary__1(rest, acc ++ previous_acc, stack, context, line, offset)
  end
  ...
  defp parse_binary__278(<<"{{!", rest::binary>>, acc, stack, context, comb__line, comb__offset) do
    parse_binary__279(rest, acc, stack, context, comb__line, comb__offset + 3)
  end
  ...
  defp parse_binary__279(<<"}}", rest::binary>>, acc, stack, context, comb__line, comb__offset) do
    parse_binary__281(rest, acc, stack, context, comb__line, comb__offset + 2)
  end

  defp parse_binary__279(rest, acc, stack, context, line, offset) do
    parse_binary__280(rest, acc, stack, context, line, offset)
  end

  defp parse_binary__280(<<byte, rest::binary>>, acc, stack, context, line, offset) do
    parse_binary__279(
      rest,
      acc,
      stack,
  ...
  defp parse_binary__280(rest, _acc, stack, context, line, offset) do
    [_, _, acc | stack] = stack
    parse_binary__274(rest, acc, stack, context, line, offset)
  end

  defp parse_binary__281(rest, user_acc, [acc | stack], context, line, offset) do
    _ = user_acc
    parse_binary__282(rest, [:comment] ++ acc, stack, context, line, offset)
  end

  defp parse_binary__282(rest, acc, [_, previous_acc | stack], context, line, offset) do
    parse_binary__276(rest, acc ++ previous_acc, stack, context, line, offset)
  end

  defp parse_binary__283(_, _, [{rest, context, line, offset} | _] = stack, _, _, _) do
    parse_binary__277(rest, [], stack, context, line, offset)
  end

  defp parse_binary__284(rest, acc, stack, context, line, offset) do
    parse_binary__285(rest, [], [acc | stack], context, line, offset)
  end
  ...
  defp parse_binary__291(rest, acc, [_, previous_acc | stack], context, line, offset) do
    parse_binary__276(rest, acc ++ previous_acc, stack, context, line, offset)
  end

  defp parse_binary__292(_, _, [{rest, context, line, offset} | _] = stack, _, _, _) do
    parse_binary__284(rest, [], stack, context, line, offset)
  end
  ...
  defp parse_binary__294(rest, acc, stack, context, line, offset) do
    parse_binary__395(
      rest,
      [],
      [{rest, context, line, offset}, acc | stack],
  ...
  defp parse_binary__297(<<"{{&", rest::binary>>, acc, stack, context, comb__line, comb__offset) do
    parse_binary__298(rest, [] ++ acc, stack, context, comb__line, comb__offset + 3)
  end

  defp parse_binary__297(rest, _acc, stack, context, line, offset) do
    [_, _, _, acc | stack] = stack
    parse_binary__292(rest, acc, stack, context, line, offset)
  end

  defp parse_binary__298(rest, acc, stack, context, line, offset) do
    parse_binary__299(rest, [], [acc | stack], context, line, offset)
  end
  ...
  defp parse_binary__301(rest, acc, [_, previous_acc | stack], context, line, offset) do
    parse_binary__300(rest, acc ++ previous_acc, stack, context, line, offset)
  end

  defp parse_binary__302(_, _, [{rest, context, line, offset} | _] = stack, _, _, _) do
  ...
  defp parse_binary__304(
       ...
       when x0 === 32 do
    parse_binary__305(rest, acc, stack, context, comb__line, comb__offset + 1)
  end

  defp parse_binary__304(rest, _acc, stack, context, line, offset) do
    [acc | stack] = stack
    parse_binary__302(rest, acc, stack, context, line, offset)
  end

  defp parse_binary__305(
         <<x0::integer, rest::binary>>,
         acc,
         stack,
         context,
       ...
       when x0 === 32 do
    parse_binary__307(rest, acc, stack, context, comb__line, comb__offset + 1)
  end
  ...
  defp parse_binary__306(rest, user_acc, [acc | stack], context, line, offset) do
    _ = user_acc
    parse_binary__308(rest, acc, stack, context, line, offset)
  end

  defp parse_binary__308(rest, acc, [_, previous_acc | stack], context, line, offset) do
    parse_binary__300(rest, acc ++ previous_acc, stack, context, line, offset)
  end

  defp parse_binary__300(rest, user_acc, [acc | stack], context, line, offset) do
    _ = user_acc
    parse_binary__309(rest, [] ++ acc, stack, context, line, offset)
  end
  ...
  defp parse_binary__310(rest, _acc, stack, context, line, offset) do
    [_, _, _, _, acc | stack] = stack
    parse_binary__292(rest, acc, stack, context, line, offset)
  end
  ...
  defp parse_binary__311(
       ...
       when (x0 >= 97 and x0 <= 122) or (x0 >= 65 and x0 <= 90) or (x0 >= 48 and x0 <= 57) or
              x0 === 95 or x0 === 46 do
    parse_binary__313(rest, [x0] ++ acc, stack, context, comb__line, comb__offset + 1)
  end
  ...
  defp parse_binary__312(rest, user_acc, [acc | stack], context, line, offset) do
    _ = user_acc
  ...
  defp parse_binary__317(rest, acc, [_, previous_acc | stack], context, line, offset) do
    parse_binary__316(rest, acc ++ previous_acc, stack, context, line, offset)
  end

  defp parse_binary__318(_, _, [{rest, context, line, offset} | _] = stack, _, _, _) do
  ...
  defp parse_binary__320(
       ...
       when x0 === 32 do
    parse_binary__321(rest, acc, stack, context, comb__line, comb__offset + 1)
  end

  defp parse_binary__320(rest, _acc, stack, context, line, offset) do
    [acc | stack] = stack
    parse_binary__318(rest, acc, stack, context, line, offset)
  end

  defp parse_binary__321(
         <<x0::integer, rest::binary>>,
         acc,
         stack,
         context,
       ...
       when x0 === 32 do
    parse_binary__323(rest, acc, stack, context, comb__line, comb__offset + 1)
  end
  ...
  defp parse_binary__322(rest, user_acc, [acc | stack], context, line, offset) do
    _ = user_acc
    parse_binary__324(rest, acc, stack, context, line, offset)
  end

  defp parse_binary__324(rest, acc, [_, previous_acc | stack], context, line, offset) do
    parse_binary__316(rest, acc ++ previous_acc, stack, context, line, offset)
  end

  defp parse_binary__316(rest, user_acc, [acc | stack], context, line, offset) do
    _ = user_acc
    parse_binary__325(rest, [] ++ acc, stack, context, line, offset)
  end

  defp parse_binary__325(<<"}}", rest::binary>>, acc, stack, context, comb__line, comb__offset) do
    parse_binary__326(rest, [] ++ acc, stack, context, comb__line, comb__offset + 2)
  end

  defp parse_binary__325(rest, _acc, stack, context, line, offset) do
    [_, _, _, acc | stack] = stack
    parse_binary__292(rest, acc, stack, context, line, offset)
  end
  ...
  defp parse_binary__327(rest, acc, [_, previous_acc | stack], context, line, offset) do
    parse_binary__295(rest, acc ++ previous_acc, stack, context, line, offset)
  end

  defp parse_binary__328(_, _, [{rest, context, line, offset} | _] = stack, _, _, _) do
  ...
  defp parse_binary__330(<<"{{{", rest::binary>>, acc, stack, context, comb__line, comb__offset) do
    parse_binary__331(rest, [] ++ acc, stack, context, comb__line, comb__offset + 3)
  end

  defp parse_binary__330(rest, _acc, stack, context, line, offset) do
    [acc | stack] = stack
  ...
  defp parse_binary__334(rest, acc, [_, previous_acc | stack], context, line, offset) do
    parse_binary__333(rest, acc ++ previous_acc, stack, context, line, offset)
  end

  defp parse_binary__335(_, _, [{rest, context, line, offset} | _] = stack, _, _, _) do
    parse_binary__334(rest, [], stack, context, line, offset)
  end

  defp parse_binary__336(rest, acc, stack, context, line, offset) do
    parse_binary__337(rest, [], [acc | stack], context, line, offset)
  end

  defp parse_binary__337(
         <<x0::integer, rest::binary>>,
         acc,
         stack,
         context,
       ...
       when x0 === 32 do
    parse_binary__338(rest, acc, stack, context, comb__line, comb__offset + 1)
  end

  defp parse_binary__337(rest, _acc, stack, context, line, offset) do
    [acc | stack] = stack
    parse_binary__335(rest, acc, stack, context, line, offset)
  end

  defp parse_binary__338(
         <<x0::integer, rest::binary>>,
         acc,
         stack,
         context,
       ...
       when x0 === 32 do
    parse_binary__340(rest, acc, stack, context, comb__line, comb__offset + 1)
  end
  ...
  defp parse_binary__340(rest, acc, stack, context, line, offset) do
    parse_binary__338(rest, acc, stack, context, line, offset)
  end

  defp parse_binary__339(rest, user_acc, [acc | stack], context, line, offset) do
    _ = user_acc
  ...
  defp parse_binary__344(
       ...
       when (x0 >= 97 and x0 <= 122) or (x0 >= 65 and x0 <= 90) or (x0 >= 48 and x0 <= 57) or
              x0 === 95 or x0 === 46 do
    parse_binary__346(rest, [x0] ++ acc, stack, context, comb__line, comb__offset + 1)
  end

  defp parse_binary__344(rest, acc, stack, context, line, offset) do
  ...
  defp parse_binary__345(rest, user_acc, [acc | stack], context, line, offset) do
    _ = user_acc
  ...
  defp parse_binary__350(rest, acc, [_, previous_acc | stack], context, line, offset) do
    parse_binary__349(rest, acc ++ previous_acc, stack, context, line, offset)
  end

  defp parse_binary__351(_, _, [{rest, context, line, offset} | _] = stack, _, _, _) do
    parse_binary__350(rest, [], stack, context, line, offset)
  end
  ...
  defp parse_binary__353(
       ...
       when x0 === 32 do
    parse_binary__354(rest, acc, stack, context, comb__line, comb__offset + 1)
  end
  ...
  defp parse_binary__354(
       ...
       when x0 === 32 do
    parse_binary__356(rest, acc, stack, context, comb__line, comb__offset + 1)
  end
  ...
  defp parse_binary__357(rest, acc, [_, previous_acc | stack], context, line, offset) do
    parse_binary__349(rest, acc ++ previous_acc, stack, context, line, offset)
  end
  ...
  defp parse_binary__358(<<"}}}", rest::binary>>, acc, stack, context, comb__line, comb__offset) do
    parse_binary__359(rest, [] ++ acc, stack, context, comb__line, comb__offset + 3)
  end

  defp parse_binary__358(rest, _acc, stack, context, line, offset) do
    [acc | stack] = stack
    parse_binary__328(rest, acc, stack, context, line, offset)
  end
  ...
  defp parse_binary__361(_, _, [{rest, context, line, offset} | _] = stack, _, _, _) do
    parse_binary__329(rest, [], stack, context, line, offset)
  end
  ...
  defp parse_binary__363(<<"{{", rest::binary>>, acc, stack, context, comb__line, comb__offset) do
    parse_binary__364(rest, [] ++ acc, stack, context, comb__line, comb__offset + 2)
  end
  ...
  defp parse_binary__367(rest, acc, [_, previous_acc | stack], context, line, offset) do
    parse_binary__366(rest, acc ++ previous_acc, stack, context, line, offset)
  end

  defp parse_binary__368(_, _, [{rest, context, line, offset} | _] = stack, _, _, _) do
    parse_binary__367(rest, [], stack, context, line, offset)
  end
  ...
  defp parse_binary__370(rest, _acc, stack, context, line, offset) do
    [acc | stack] = stack
    parse_binary__368(rest, acc, stack, context, line, offset)
  end

  defp parse_binary__371(
         <<x0::integer, rest::binary>>,
         acc,
         stack,
         context,
       ...
       when x0 === 32 do
    parse_binary__373(rest, acc, stack, context, comb__line, comb__offset + 1)
  end
  ...
  defp parse_binary__373(rest, acc, stack, context, line, offset) do
    parse_binary__371(rest, acc, stack, context, line, offset)
  end
  ...
  defp parse_binary__366(rest, user_acc, [acc | stack], context, line, offset) do
    _ = user_acc
  ...
  defp parse_binary__376(rest, _acc, stack, context, line, offset) do
    [_, acc | stack] = stack
    parse_binary__361(rest, acc, stack, context, line, offset)
  end
  ...
  defp parse_binary__377(
       ...
       when (x0 >= 97 and x0 <= 122) or (x0 >= 65 and x0 <= 90) or (x0 >= 48 and x0 <= 57) or
              x0 === 95 or x0 === 46 do
    parse_binary__379(rest, [x0] ++ acc, stack, context, comb__line, comb__offset + 1)
  end
  ...
  defp parse_binary__383(rest, acc, [_, previous_acc | stack], context, line, offset) do
    parse_binary__382(rest, acc ++ previous_acc, stack, context, line, offset)
  end

  defp parse_binary__384(_, _, [{rest, context, line, offset} | _] = stack, _, _, _) do
    parse_binary__383(rest, [], stack, context, line, offset)
  end
  ...
  defp parse_binary__386(
       ...
       when x0 === 32 do
    parse_binary__387(rest, acc, stack, context, comb__line, comb__offset + 1)
  end

  defp parse_binary__386(rest, _acc, stack, context, line, offset) do
    [acc | stack] = stack
    parse_binary__384(rest, acc, stack, context, line, offset)
  end

  defp parse_binary__387(
         <<x0::integer, rest::binary>>,
         acc,
         stack,
         context,
       ...
       when x0 === 32 do
    parse_binary__389(rest, acc, stack, context, comb__line, comb__offset + 1)
  end
  ...
  defp parse_binary__388(rest, user_acc, [acc | stack], context, line, offset) do
    _ = user_acc
    parse_binary__390(rest, acc, stack, context, line, offset)
  end

  defp parse_binary__390(rest, acc, [_, previous_acc | stack], context, line, offset) do
    parse_binary__382(rest, acc ++ previous_acc, stack, context, line, offset)
  end

  defp parse_binary__382(rest, user_acc, [acc | stack], context, line, offset) do
    _ = user_acc
  ...
  defp parse_binary__392(rest, user_acc, [acc | stack], context, line, offset) do
    _ = user_acc
  ...
  defp parse_binary__393(rest, acc, [_, previous_acc | stack], context, line, offset) do
    parse_binary__295(rest, acc ++ previous_acc, stack, context, line, offset)
  end

  defp parse_binary__394(_, _, [{rest, context, line, offset} | _] = stack, _, _, _) do
    parse_binary__362(rest, [], stack, context, line, offset)
  end
  ...
  defp parse_binary__396(<<"{{", rest::binary>>, acc, stack, context, comb__line, comb__offset) do
    parse_binary__397(rest, acc, stack, context, comb__line, comb__offset + 2)
  end

  defp parse_binary__396(rest, _acc, stack, context, line, offset) do
    [acc | stack] = stack
  ...
  defp parse_binary__400(rest, acc, [_, previous_acc | stack], context, line, offset) do
    parse_binary__399(rest, acc ++ previous_acc, stack, context, line, offset)
  end

  defp parse_binary__401(_, _, [{rest, context, line, offset} | _] = stack, _, _, _) do
    parse_binary__400(rest, [], stack, context, line, offset)
  end

  defp parse_binary__402(rest, acc, stack, context, line, offset) do
  ...
  defp parse_binary__403(
       ...
       when x0 === 32 do
    parse_binary__404(rest, acc, stack, context, comb__line, comb__offset + 1)
  end
  ...
  defp parse_binary__404(
       ...
       when x0 === 32 do
    parse_binary__406(rest, acc, stack, context, comb__line, comb__offset + 1)
  end
  ...
  defp parse_binary__406(rest, acc, stack, context, line, offset) do
  ...
  defp parse_binary__399(rest, user_acc, [acc | stack], context, line, offset) do
    _ = user_acc
    parse_binary__408(rest, acc, stack, context, line, offset)
  end

  defp parse_binary__408(<<".", rest::binary>>, acc, stack, context, comb__line, comb__offset) do
    parse_binary__409(rest, acc, stack, context, comb__line, comb__offset + 1)
  end
  ...
  defp parse_binary__412(rest, acc, [_, previous_acc | stack], context, line, offset) do
    parse_binary__411(rest, acc ++ previous_acc, stack, context, line, offset)
  end

  defp parse_binary__413(_, _, [{rest, context, line, offset} | _] = stack, _, _, _) do
    parse_binary__412(rest, [], stack, context, line, offset)
  end
  ...
  defp parse_binary__416(
       ...
       when x0 === 32 do
    parse_binary__418(rest, acc, stack, context, comb__line, comb__offset + 1)
  end

  defp parse_binary__416(rest, acc, stack, context, line, offset) do
  ...
  defp parse_binary__419(rest, acc, [_, previous_acc | stack], context, line, offset) do
    parse_binary__411(rest, acc ++ previous_acc, stack, context, line, offset)
  end

  defp parse_binary__411(rest, user_acc, [acc | stack], context, line, offset) do
    _ = user_acc
  ...
  defp parse_binary__421(rest, user_acc, [acc | stack], context, line, offset) do
    _ = user_acc
    parse_binary__422(rest, [:current_element] ++ acc, stack, context, line, offset)
  end
  ...
  defp parse_binary__295(rest, user_acc, [acc | stack], context, line, offset) do
    _ = user_acc
  ...
  defp parse_binary__423(rest, acc, [_, previous_acc | stack], context, line, offset) do
    parse_binary__276(rest, acc ++ previous_acc, stack, context, line, offset)
  end

  defp parse_binary__424(_, _, [{rest, context, line, offset} | _] = stack, _, _, _) do
    parse_binary__293(rest, [], stack, context, line, offset)
  end
  ...
  defp parse_binary__428(
       ...
       when x0 === 35 or x0 === 94 do
    parse_binary__429(rest, [x0] ++ acc, stack, context, comb__line, comb__offset + 3)
  end
  ...
  defp parse_binary__432(rest, acc, [_, previous_acc | stack], context, line, offset) do
    parse_binary__431(rest, acc ++ previous_acc, stack, context, line, offset)
  end

  defp parse_binary__433(_, _, [{rest, context, line, offset} | _] = stack, _, _, _) do
    parse_binary__432(rest, [], stack, context, line, offset)
  end
  ...
  defp parse_binary__435(rest, _acc, stack, context, line, offset) do
    [acc | stack] = stack
    parse_binary__433(rest, acc, stack, context, line, offset)
  end

  defp parse_binary__436(
         <<x0::integer, rest::binary>>,
         acc,
         stack,
         context,
  ...
  defp parse_binary__438(rest, acc, stack, context, line, offset) do
    parse_binary__436(rest, acc, stack, context, line, offset)
  end
  ...
  defp parse_binary__431(rest, user_acc, [acc | stack], context, line, offset) do
    _ = user_acc
  ...
  defp parse_binary__442(
       ...
       when (x0 >= 97 and x0 <= 122) or (x0 >= 65 and x0 <= 90) or (x0 >= 48 and x0 <= 57) or
              x0 === 95 or x0 === 46 do
    parse_binary__444(rest, [x0] ++ acc, stack, context, comb__line, comb__offset + 1)
  end
  ...
  defp parse_binary__444(rest, acc, stack, context, line, offset) do
  ...
  defp parse_binary__456(<<"}}", rest::binary>>, acc, stack, context, comb__line, comb__offset) do
    parse_binary__457(rest, [] ++ acc, stack, context, comb__line, comb__offset + 2)
  end

  defp parse_binary__456(rest, _acc, stack, context, line, offset) do
    [_, _, acc | stack] = stack
    parse_binary__424(rest, acc, stack, context, line, offset)
  end

  defp parse_binary__457(rest, user_acc, [acc | stack], context, line, offset) do
    _ = user_acc
    parse_binary__458(rest, [:lists.reverse(user_acc)] ++ acc, stack, context, line, offset)
  end

  defp parse_binary__458(<<"{{/", _::binary>> = rest, acc, stack, context, line, offset) do
    [_, acc | stack] = stack
    parse_binary__424(rest, acc, stack, context, line, offset)
  end
  ...
  defp parse_binary__459(rest, acc, stack, context, line, offset) do
    case(parse_binary__0(rest, acc, [], context, line, offset)) do
      {:ok, acc, rest, context, line, offset} ->
  ...
  defp parse_binary__460(<<"{{/", rest::binary>>, acc, stack, context, comb__line, comb__offset) do
    parse_binary__461(rest, [] ++ acc, stack, context, comb__line, comb__offset + 3)
  end

  defp parse_binary__460(rest, _acc, stack, context, line, offset) do
    [_, acc | stack] = stack
    parse_binary__424(rest, acc, stack, context, line, offset)
  end
  ...
  defp parse_binary__472(rest, acc, stack, context, line, offset) do
    parse_binary__473(rest, [], [acc | stack], context, line, offset)
  end

  defp parse_binary__473(
         <<x0::integer, rest::binary>>,
         acc,
         stack,
         context,
  ...
  defp parse_binary__473(rest, _acc, stack, context, line, offset) do
    [_, _, acc | stack] = stack
    parse_binary__424(rest, acc, stack, context, line, offset)
  end

  defp parse_binary__474(
         <<x0::integer, rest::binary>>,
         acc,
         stack,
         context,
       ...
       when (x0 >= 97 and x0 <= 122) or (x0 >= 65 and x0 <= 90) or (x0 >= 48 and x0 <= 57) or
              x0 === 95 or x0 === 46 do
    parse_binary__476(rest, [x0] ++ acc, stack, context, comb__line, comb__offset + 1)
  end
  ...
  defp parse_binary__476(rest, acc, stack, context, line, offset) do
    parse_binary__474(rest, acc, stack, context, line, offset)
  end

  defp parse_binary__475(rest, user_acc, [acc | stack], context, line, offset) do
    _ = user_acc
  ...
  defp parse_binary__488(<<"}}", rest::binary>>, acc, stack, context, comb__line, comb__offset) do
    parse_binary__489(rest, [] ++ acc, stack, context, comb__line, comb__offset + 2)
  end

  defp parse_binary__488(rest, _acc, stack, context, line, offset) do
    [_, acc | stack] = stack
    parse_binary__424(rest, acc, stack, context, line, offset)
  end

  defp parse_binary__489(rest, user_acc, [acc | stack], context, line, offset) do
    _ = user_acc
  ...
  defp parse_binary__490(rest, user_acc, [acc | stack], context, line, offset) do
    _ = user_acc
  ...
  defp parse_binary__491(rest, acc, [_, previous_acc | stack], context, line, offset) do
    parse_binary__276(rest, acc ++ previous_acc, stack, context, line, offset)
  end

  defp parse_binary__492(_, _, [{rest, context, line, offset} | _] = stack, _, _, _) do
    parse_binary__425(rest, [], stack, context, line, offset)
  end
  ...
  defp parse_binary__495(<<"{{", rest::binary>>, acc, stack, context, comb__line, comb__offset) do
    parse_binary__496(rest, [] ++ acc, stack, context, comb__line, comb__offset + 2)
  end

  defp parse_binary__495(rest, _acc, stack, context, line, offset) do
    [_, acc | stack] = stack
  ...
  defp parse_binary__501(<<" ", rest::binary>>, acc, stack, context, comb__line, comb__offset) do
    parse_binary__502(rest, [] ++ acc, stack, context, comb__line, comb__offset + 1)
  end

  defp parse_binary__501(rest, _acc, stack, context, line, offset) do
    [_, acc | stack] = stack
    parse_binary__492(rest, acc, stack, context, line, offset)
  end
  ...
  defp parse_binary__503(rest, acc, stack, context, line, offset) do
    parse_binary__504(rest, [], [acc | stack], context, line, offset)
  end

  defp parse_binary__504(<<"='", _::binary>> = rest, acc, stack, context, line, offset) do
    [_, _, _, acc | stack] = stack
    parse_binary__492(rest, acc, stack, context, line, offset)
  end

  defp parse_binary__504(rest, acc, stack, context, line, offset) do
    parse_binary__505(rest, acc, stack, context, line, offset)
  end

  defp parse_binary__505(rest, acc, stack, context, line, offset) do
    parse_binary__506(rest, [], [acc | stack], context, line, offset)
  end

  defp parse_binary__506(
         <<x0::integer, rest::binary>>,
         acc,
         stack,
         context,
  ...
  defp parse_binary__506(rest, _acc, stack, context, line, offset) do
    [_, _, _, _, acc | stack] = stack
    parse_binary__492(rest, acc, stack, context, line, offset)
  end
  ...
  defp parse_binary__507(
       ...
       when (x0 >= 97 and x0 <= 122) or (x0 >= 65 and x0 <= 90) or (x0 >= 48 and x0 <= 57) or
              x0 === 95 or x0 === 46 do
    parse_binary__509(rest, [x0] ++ acc, stack, context, comb__line, comb__offset + 1)
  end

  defp parse_binary__507(rest, acc, stack, context, line, offset) do
  ...
  defp parse_binary__508(rest, user_acc, [acc | stack], context, line, offset) do
    _ = user_acc
  ...
  defp parse_binary__510(<<"='", rest::binary>>, acc, stack, context, comb__line, comb__offset) do
    parse_binary__511(rest, [] ++ acc, stack, context, comb__line, comb__offset + 2)
  end

  defp parse_binary__510(rest, _acc, stack, context, line, offset) do
    [_, _, _, acc | stack] = stack
    parse_binary__492(rest, acc, stack, context, line, offset)
  end

  defp parse_binary__511(rest, acc, stack, context, line, offset) do
    parse_binary__512(rest, [], [acc | stack], context, line, offset)
  end

  defp parse_binary__512(
         <<x0::integer, rest::binary>>,
         acc,
         stack,
         context,
  ...
  defp parse_binary__513(rest, acc, stack, context, line, offset) do
    parse_binary__514(rest, acc, stack, context, line, offset)
  end

  defp parse_binary__515(rest, acc, stack, context, line, offset) do
  ...
  defp parse_binary__516(rest, user_acc, [acc | stack], context, line, offset) do
    _ = user_acc
  ...
  defp parse_binary__519(<<" ", rest::binary>>, acc, stack, context, comb__line, comb__offset) do
    parse_binary__520(rest, acc, stack, context, comb__line, comb__offset + 1)
  end

  defp parse_binary__519(<<rest::binary>>, acc, stack, context, comb__line, comb__offset) do
    parse_binary__520(rest, acc, stack, context, comb__line, comb__offset)
  end

  defp parse_binary__520(rest, user_acc, [acc | stack], context, line, offset) do
    _ = user_acc
    parse_binary__521(rest, [] ++ acc, stack, context, line, offset)
  end

  defp parse_binary__521(rest, user_acc, [acc | stack], context, line, offset) do
    _ = user_acc
  ...
  defp parse_binary__524(rest, acc, stack, context, line, offset) do
    parse_binary__525(rest, [], [acc | stack], context, line, offset)
  end

  defp parse_binary__525(rest, acc, stack, context, line, offset) do
    parse_binary__526(rest, [], [acc | stack], context, line, offset)
  end

  defp parse_binary__526(<<"='", _::binary>> = rest, acc, stack, context, line, offset) do
    [_, acc | stack] = stack
  ...
  defp parse_binary__529(
       ...
       when (x0 >= 97 and x0 <= 122) or (x0 >= 65 and x0 <= 90) or (x0 >= 48 and x0 <= 57) or
              x0 === 95 or x0 === 46 do
    parse_binary__531(rest, [x0] ++ acc, stack, context, comb__line, comb__offset + 1)
  end
  ...
  defp parse_binary__532(<<"='", rest::binary>>, acc, stack, context, comb__line, comb__offset) do
    parse_binary__533(rest, [] ++ acc, stack, context, comb__line, comb__offset + 2)
  end

  defp parse_binary__532(rest, _acc, stack, context, line, offset) do
    [_, acc | stack] = stack
    parse_binary__523(rest, acc, stack, context, line, offset)
  end

  defp parse_binary__533(rest, acc, stack, context, line, offset) do
    parse_binary__534(rest, [], [acc | stack], context, line, offset)
  end

  defp parse_binary__534(
         <<x0::integer, rest::binary>>,
         acc,
         stack,
         context,
  ...
  defp parse_binary__539(<<"'", rest::binary>>, acc, stack, context, comb__line, comb__offset) do
    parse_binary__540(rest, [] ++ acc, stack, context, comb__line, comb__offset + 1)
  end

  defp parse_binary__539(rest, _acc, stack, context, line, offset) do
    [acc | stack] = stack
    parse_binary__523(rest, acc, stack, context, line, offset)
  end
  ...
  defp parse_binary__541(<<rest::binary>>, acc, stack, context, comb__line, comb__offset) do
    parse_binary__542(rest, acc, stack, context, comb__line, comb__offset)
  end

  defp parse_binary__542(rest, user_acc, [acc | stack], context, line, offset) do
    _ = user_acc
    parse_binary__543(rest, [] ++ acc, stack, context, line, offset)
  end

  defp parse_binary__543(rest, user_acc, [acc | stack], context, line, offset) do
    _ = user_acc
  ...
  defp parse_binary__523(_, _, [{rest, acc, context, line, offset} | stack], _, _, _) do
  ...
  defp parse_binary__545(<<"}}", rest::binary>>, acc, stack, context, comb__line, comb__offset) do
    parse_binary__546(rest, [] ++ acc, stack, context, comb__line, comb__offset + 2)
  end

  defp parse_binary__545(rest, _acc, stack, context, line, offset) do
    [_, acc | stack] = stack
    parse_binary__492(rest, acc, stack, context, line, offset)
  end
  ...
  defp parse_binary__547(rest, user_acc, [acc | stack], context, line, offset) do
    _ = user_acc
  ...
  defp parse_binary__548(rest, acc, [_, previous_acc | stack], context, line, offset) do
    parse_binary__276(rest, acc ++ previous_acc, stack, context, line, offset)
  end

  defp parse_binary__274(_, _, [{rest, acc, context, line, offset} | stack], _, _, _) do
  ...
  defp parse_binary__549(rest, acc, _stack, context, line, offset) do
    {:ok, acc, rest, context, line, offset}
  end
end
